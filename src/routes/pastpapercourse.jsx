...
const courses = [
  { name: "Computer", path: "/pastpaper" },
  { name: "English", path: "/englishchatbot" },
  { name: "Maths", path: "/mathschatbot" },
  { name: "Biology", path: "/biologychatbot" },
  { name: "Chemistry", path: "/chemistrychatbot" },
  { name: "Physics", path: "/physicschatbot" },
  { name: "History", path: "/historychatbot" },
  { name: "Geography", path: "/geographychatbot" },
];

const Pastpapercourse = () => {
...
export default Pastpapercourse;